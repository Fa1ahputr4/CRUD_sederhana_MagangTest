...
<div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="text-gray-800 light:text-gray-300">
        {{ __('Dashboard') }}
    </x-nav-link>
    <x-nav-link :href="route('departemen')" :active="request()->routeIs('departemen')" class="text-gray-800 light:text-gray-300">
        {{ __('Departemen') }}
    </x-nav-link>
    <x-nav-link :href="route('employee')" :active="request()->routeIs('employee')" class="text-gray-800 light:text-gray-300">
        {{ __('Employee') }}
    </x-nav-link>
</div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                <x-responsive-nav-link :href="route('departemen')" :active="request()->routeIs('departemen')">
                    {{ __('Departemen') }}
                </x-responsive-nav-link>
            </div>
            <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
